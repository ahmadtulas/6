 ...
 * @return {boolean} True if a string, false if not.
 */
 ...
 * @return {Promise<Array>} A flattened array containing only config objects.
 ...
 *      found.
 * @param {Array<string>} extraConfigTypes The config types to check.
 * @return {Array} A flattened array containing only config objects.
 * @throws {TypeError} When a config function returns a function.
 */
 ...
 * @param {Object} config The config object to check.
 * @return {boolean} True if the file path is matched by the config,
 *      false if not.
 */
...
class ConfigArray extends Array {
  ...
  /**
	 ...
	 * @return {Function} The `Array` constructor.
	 */
  ...
  /**
	 ...
	 * @return {Array<string|Function>} An array of matchers.
	 */
  get files() {
  ...
  /**
	 ...
	 * @return {string[]} An array of string patterns and functions to be ignored.
	 */
  get ignores() {
    assertNormalized(this);
  ...
  /**
	 ...
	 * @return {boolean} True if the config array is normalized, false if not.
	 */
  isNormalized() {
  ...
  /**
	 ...
	 * @return {Promise<ConfigArray>} The current ConfigArray instance.
	 */
  ...
  /**
	 ...
	 * config functions.
	 * @param {ConfigContext} context The context object for config functions.
	 * @return {ConfigArray} The current ConfigArray instance.
	 */
  ...
  /**
	 ...
	 * @return {Object} The finalized config.
	 */
  ...
  /**
	 ...
	 * @return {Object} The config to use in place of the argument.
	 */
  ...
  /**
	 ...
	 * @return {boolean} True if the file path matches a `files` entry
	 * 		or false if not.
	 */
  ...
  /**
	 ...
	 * @return {Object} The config object for this file.
	 */
  getConfig(filePath) {
    assertNormalized(this);
  ...
  /**
	 ...
	 * @param {string} filePath The complete path of a file to check.
	 * @return {boolean} True if the path is ignored, false if not.
  ...
  /**
	 ...
	 * @return {boolean} True if the directory is ignored, false if not. Will
